...
const Footer = () => {
  return (
    <footer className="bg-white absolute bottom-0 flex w-full flex-col items-center justify-between gap-2 border-t-[1px] px-3 py-2 sm:mb-0 sm:h-12 sm:flex-row sm:px-6">
